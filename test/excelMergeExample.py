...
def excelMerge():
    ...
    path = "C:\\Users\\Onur\\Desktop\\Desktop\\ONUR"
    ...
    #Adjusting
    #excl_merged.sort_values(by=['T.C. KİMLİK NO.'], inplace=True, ascending=False)#Sortin values acoording to Rating column.
...
def createExcel():# exports the dataframe into excel file with specified name.
    file_name='AABTÜMÜ.xlsx'
    sheet_name = 'Final'
    writer = pd.ExcelWriter("C:\\Users\\Onur\\Desktop\\Desktop\\ONUR\\"+file_name, engine='xlsxwriter')
